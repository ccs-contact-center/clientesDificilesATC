            ...
            <Col xs="12" className="centrado-fila">
              ...
              >
                <p className="text-justify animated  fadeInDown  delay-3s ">
                  ...
                  productos y servicios con tantas modificaciones como personas
                  hay, algo objetivamente imposible. Ello, nos lleva a la
                  necesidad de conjugar dicha diferenciación con las
                  posibilidades reales de atención al cliente y para ello, una
                  de las soluciones encontrada es la de agrupar a los clientes,
                  según una serie de criterios comunes. Se trata de establecer
                  distintas tipologías de clientes con unas motivaciones y
